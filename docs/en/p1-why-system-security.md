# System Security Research Survival Guide


System security focuses on the relationship between attackers, vulnerabilities,
and assets, and protects critical assets by discovering and fixing flaws while
building effective defenses. It sounds noble, and
...
software to upper-layer applications.  Its key mechanisms include boot-time integrity
and run-time trust.

System security is not about flashy ideas, but about verifiable safety and
...
This often means system security research receives support at the national level.
...
research problems that are shaping the future of system security:
